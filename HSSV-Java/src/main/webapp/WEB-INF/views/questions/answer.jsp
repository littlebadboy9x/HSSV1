...
<body>
    <div class="container">
            ...
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <div class="text-muted">
                        <small>
                            Người đăng: ${question.user.fullName}
                        </small>
                        <small class="ms-2">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="${pageContext.request.contextPath}/questions/${question.id}/answer" 
    ...
    document.addEventListener('DOMContentLoaded', function() {
        document.getElementById('answer_content_main').addEventListener('input', function() {
