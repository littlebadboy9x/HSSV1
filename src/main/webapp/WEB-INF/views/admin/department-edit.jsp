...
<head>
    ...
    <title>Chỉnh sửa Khoa/Đơn vị - Hệ thống Tư vấn Sinh viên</title>
    ...
    <div class="container mt-4">
        ...
        <c:if test="${department != null}">
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <h5 class="card-title mb-0">Thông tin khoa/đơn vị</h5>
                </div>
                <div class="card-body">
                    <form action="${pageContext.request.contextPath}/admin/departments" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name" name="name" required 
                                   maxlength="100" value="${department.name}" 
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="code" name="code" required 
                                   maxlength="20" value="${department.code}" 
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="description" name="description" 
                                      rows="4" placeholder="Nhập mô tả khoa/đơn vị">${department.description}</textarea>
        ...
        <c:if test="${department == null}">
            <div class="alert alert-warning" role="alert">
                <i class="fas fa-exclamation-triangle"></i> Không tìm thấy khoa/đơn vị với ID được cung cấp.
                <br>
                <a href="${pageContext.request.contextPath}/admin/departments" class="btn btn-sm btn-warning mt-2">
                    Quay lại danh sách khoa/đơn vị
                </a>
            </div>
        </c:if>
    </div>
