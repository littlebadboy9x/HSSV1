...
<head>
    ...
    <title>Chỉnh sửa Ngành học - Hệ thống Tư vấn Sinh viên</title>
    ...
    <div class="container mt-4">
        ...
        <c:if test="${major != null}">
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <h5 class="card-title mb-0">Thông tin ngành học</h5>
                </div>
                <div class="card-body">
                    <form action="${pageContext.request.contextPath}/admin/majors" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name" name="name" required 
                                   maxlength="100" value="${major.name}" 
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="departmentId" name="departmentId" required>
                                ...
                                <c:forEach var="department" items="${departments}">
                                    <option value="${department.id}" ${major.department.id eq department.id ? 'selected' : ''}>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="description" name="description" 
                                      rows="4" placeholder="Nhập mô tả ngành học">${major.description}</textarea>
        ...
        <c:if test="${major == null}">
            <div class="alert alert-warning" role="alert">
                <i class="fas fa-exclamation-triangle"></i> Không tìm thấy ngành học với ID được cung cấp.
                <br>
                <a href="${pageContext.request.contextPath}/admin/majors" class="btn btn-sm btn-warning mt-2">
