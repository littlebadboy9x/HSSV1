...
<head>
    ...
    <title>Quản lý Danh mục Câu hỏi - Hệ thống Tư vấn Sinh viên</title>
    ...
    <div class="container mt-4">
            ...
            <div class="alert alert-success alert-dismissible fade show" role="alert">
                <c:choose>
                    <c:when test="${param.message == 'create_success'}">
                        <strong>Thành công!</strong> Danh mục mới đã được tạo.
                    </c:when>
                    <c:when test="${param.message == 'update_success'}">
                        <strong>Thành công!</strong> Danh mục đã được cập nhật.
                    </c:when>
                    <c:when test="${param.message == 'delete_success'}">
                        <strong>Thành công!</strong> Danh mục đã được xóa.
                    </c:when>
                    <c:otherwise>
            ...
            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                <c:choose>
                    <c:when test="${param.error == 'delete_failed'}">
                        <strong>Lỗi!</strong> Không thể xóa danh mục vì vẫn có câu hỏi liên kết.
                    </c:when>
                    <c:otherwise>
        ...
        <div class="card">
            <div class="card-header bg-light">
                <h5 class="card-title mb-0">Danh sách các danh mục câu hỏi</h5>
            </div>
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <p class="text-danger mt-2 mb-0">
                                                                        ...
                                                                        Lưu ý: Tất cả các câu hỏi thuộc danh mục này sẽ không còn được phân loại.
                                                                    </p>
                                                                </div>
                                                                <div class="modal-footer">
                                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Hủy</button>
                                                                    <a href="${pageContext.request.contextPath}/admin/categories?action=delete&id=${category.id}" class="btn btn-danger">Xóa</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
